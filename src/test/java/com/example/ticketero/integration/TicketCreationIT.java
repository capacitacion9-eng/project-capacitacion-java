...
class TicketCreationIT extends BaseIntegrationTest {
    ...
    class HappyPath {
        ...
        void crearTicket_datosValidos_debeCrearConOutbox() {
            ...
            // Verificar Outbox (si existe la tabla)
            int outboxCount = countOutboxMessages("PENDING");
            assertThat(outboxCount).isGreaterThanOrEqualTo(0);
        }
        ...
        void crearTickets_diferentesColas_posicionesIndependientes() {
            ...
            // Verificar mensajes en Outbox (si existe)
            assertThat(countOutboxMessages("PENDING")).isGreaterThanOrEqualTo(0);
        }
    }
    ...
    class EdgeCases {
        ...
        void consultarTicket_porCodigo_debeRetornarDatos() {
            ...
            given()
            .when()
                .get("/tickets/reference/" + codigoReferencia)
            .then()
                .statusCode(200)
